        ...
        <div className="forecast-card">
          ...
          <div className="forecast-metrics">
            <MetricCard
              ...
              format="currency"
              displayMode="compact"
              design={dashboardState.cardVariants?.predictedRevenue || 'variant1'}
              onVariantChange={(variant) => updateDashboardState?.({
                cardVariants: { ...dashboardState.cardVariants, predictedRevenue: variant }
              })}
            ...
            <MetricCard
              ...
              format="number"
              displayMode="compact"
              design={dashboardState.cardVariants?.expectedOrders || 'variant2'}
              onVariantChange={(variant) => updateDashboardState?.({
                cardVariants: { ...dashboardState.cardVariants, expectedOrders: variant }
              })}
